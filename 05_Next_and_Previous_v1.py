...
class History:
    def __init__(self, partner, job_information):
        ...
        self.show_job_number_value_label = Label(self.hist_frame,
                                      font=content, text=job_information[0][0])
        ...
        self.show_customer_name_value_label = Label(self.hist_frame,
                                      font=content, text=job_information[1][0])
        ...
        self.show_job_charge_value_label = Label(self.hist_frame,
                                      font=content, text="$ {}".format(job_information[2][0]))
        ...
        self.information_message_label = Label(self.hist_frame, font=heading,
                                               text="",fg="#B22222")
        self.information_message_label.grid(row=4, columnspan=2)

        # previous button
        self.previous_button = Button(self.hist_frame, text="Previous",
                                  width=10, command=partial(lambda: self.prev_next_btn(
                job_information, 0)))
    ...
    def prev_next_btn(self, job_information, button):
        ...
        elif time > len(job_information[0]) - 1:
