...
class History:
    ...
    def prev_next_btn(self, job_information, button):
        ...
        # check if next_button or previous button is pressed, 0 is prev and 1 is next
        if chosen_button == 0:
...
class Export:
    ...
    def save_history(self, partner, job_information):
        ...
        if has_error == "yes":
            ...
            for number in job_information[0]:
                f.write(str(number) + "\n")
...
class Export:
    def __init__(self, partner, job_information):
        ...
        # Export instructions(label, row 2)
        self.export_text = Label(self.export_frame, text="Enter a filename "
                                 "in the box below "
                                 "and press the Save "
                                 "button to save your "
