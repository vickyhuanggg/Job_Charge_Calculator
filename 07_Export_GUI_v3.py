...
class Start:
    def __init__(self, parent):
        ...
        self.show_all_job_button = Button(self.start_frame, text="Show all Job",
                                      bg="#1E90FF",command=lambda: self.to_hist(self.job_information_list, self.filenames_list))
        self.show_all_job_button.grid(row=1)

    def to_hist(self, job_information, filenames):
        History(self, job_information, filenames)
...
class History:
    def __init__(self, partner, job_information, filenames):
        ...
        self.export_button = Button(self.buttons_frame, text="Export",
                                    width=10, bg="#1E90FF",
                                    font="arial 16 bold",
                                    command=lambda: self.export(job_information,filenames))
    ...
    def export(self, job_information, filenames):
        Export(self, job_information, filenames)
...
class Export:
    def __init__(self, partner, job_information, filenames):
        ...
        self.save_button = Button(self.save_cancel_frame, text="Save",
                                  ...
                                  command=partial(lambda: self.save_history(partner, job_information,filenames)))
    ...
    def save_history(self, partner, job_information, filenames):
        ...
        elif (filename + ".txt") in filenames:
